...
import { ErrorContext, Audio } from './App';
import sound from "./Sound";
import millisToMinutesAndSeconds from "./millisToMinutesAndSeconds";

const MainTrack = (props:{play:{ added_at:string,track: { duration_ms: number, album: { name: string }, preview_url: string, name: string, artists: { name: string }[] },name: string; preview_url: string; artists: { name: string; }[]; duration_ms: number; }[],name:string,img:string,data:string}) =>{
